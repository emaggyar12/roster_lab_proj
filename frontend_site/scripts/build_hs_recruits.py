...
PREDICTIONS = ROOT / "models_dir/baseline_model_hs_playtype/jun_5_autoclass/outputs/baseline/catboost_baseline_top3_predictions.csv"
...
def main() -> None:
    ...
    df = df[~df.apply(has_destination_conflict, axis=1)].copy()
    ...
    lines = [
        ...
        "// Source: models_dir/baseline_model/jun_5_autoclass/outputs/baseline/catboost_baseline_top3_predictions.csv",
    ...
    print(f"players={len(players)} with_images={with_images} excluded_destination_conflicts={conflict_count}")
