...
DB_PATH = PROJECT_ROOT / "data_dir" / "247_bv_transf_matched.db"
ARTIFACT_DIR = MODEL_DIR / "artifacts"

SOURCE_TABLE = "transfer_247_bv_matched"

TARGET_COL = "db1_future_role"
YEAR_COL = "db1_allyears_year"

RAW_HEIGHT_COL = "247_height"
HEIGHT_IN_COL = "247_height_in"
...
TRAINING_QUERY = f"""
    SELECT
        ...
        db1_allyears_gp,
        db1_allyears_min_per,
        db1_allyears_ortg,
        db1_allyears_usg,
        db1_allyears_efg,
        db1_allyears_ts_per,
        db1_allyears_orb_per,
        db1_allyears_drb_per,
        db1_allyears_ast_per,
        db1_allyears_to_per,
        db1_allyears_ftm,
        db1_allyears_fta,
        db1_allyears_ft_per,
        db1_allyears_twopm,
        db1_allyears_twopa,
        db1_allyears_twop_per,
        db1_allyears_tpm,
        db1_allyears_tpa,
        db1_allyears_tp_per,
        db1_allyears_blk_per,
        db1_allyears_stl_per,
        db1_allyears_ftr,
        db1_allyears_yr,
        db1_allyears_ht,
        db1_allyears_num,
        db1_allyears_porpag,
        db1_allyears_adjoe,
        db1_allyears_ast_tov,
        db1_allyears_rimmade,
        db1_allyears_rimmade_rimmiss,
        db1_allyears_midmade,
        db1_allyears_midmade_midmiss,
        db1_allyears_rimmade_rimmade_rimmiss,
        db1_allyears_midmade_midmade_midmiss,
        db1_allyears_dunksmade,
        db1_allyears_dunksmiss_dunksmade,
        db1_allyears_dunksmade_dunksmade_dunksmiss,
        db1_allyears_drtg,
        db1_allyears_adrtg,
        db1_allyears_dporpag,
        db1_allyears_stops,
        db1_allyears_bpm,
        db1_allyears_obpm,
        db1_allyears_dbpm,
        ...
        "247_position_rank"
    FROM {SOURCE_TABLE}
    WHERE db1_future_role IS NOT NULL
      AND db1_allyears_year IS NOT NULL
"""
...
def write_prediction_outputs(
    ...
    out = source_df[[YEAR_COL, "db1_allyears_role"]].reset_index(drop=True).copy()
